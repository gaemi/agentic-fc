...
| Match commentary context | goals from 85' narrate as late drama; opener/equalizer calls replace the pattern line (presentation only, no RNG) | `internal/engine` `lateDramaMinute`, `goalContextCommentaryKey` | [12 §6](12-match-model.md) |
